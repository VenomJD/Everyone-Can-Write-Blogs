...
const ManageBlogs = () => {
    ...
    // Traemos el estado de autenticación y rol desde el contexto
            ...
            <InPageNavigation routes={["Published Blogs", "Drafts"]} defaultActiveIndex={activeTab !== "draft" ? 0 : 1}>
                {
                    ...
                    blogs.results.length ?
                        ...
                        : <NoDataMessage message={isAdmin ? "No published blogs available" : "You haven't published any blogs"} />
                }

                {
                    ...
                    drafts.results.length ?
                        ...
                        : <NoDataMessage message={isAdmin ? "No draft blogs available" : "You don't have any drafts"} />
                }
            </InPageNavigation>
        </>
    );
